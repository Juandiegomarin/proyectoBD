...
public class Conexion {
    ...
    private static final String NOMBRE_BASE_DATOS = "p81JuanDiegoMarinMorales";
    private static final String USER = "juandi";
    private static final String PASS = "dieguichi2002";
